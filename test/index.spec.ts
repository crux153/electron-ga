...
describe("Analytics", () => {
  ...
  describe("constructor", () => {
    it("sets the default initial params", () => {
      ...
      expect((<() => string>analytics["screenResolution"])()).toEqual(
        "200x200"
      );
    });
  ...
  describe("method getParams", () => {
    it("returns params object", () => {
      ...
      expect(
        analytics["getParams"](
          "event",
          { ec: "Video", ea: "play", el: "solarpod", ev: 123 },
          10
        )
      ).toEqual({
        __timestamp: 10,
        ...
        av: "1.0.0",
        ul: "en-GB",
        ua: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36",
        vp: "100x100",
        sr: "200x200",
        ec: "Video",
        ea: "play",
  ...
  describe("method send", () => {
    ...
    it("sends event without cache", async () => {
      ...
      expect(fetch.mock.calls[0][1]).toEqual({
        method: "post",
        body: "__timestamp=50&t=event&v=1&tid=123456&cid=123&an=abc-xyz.io&av=1.0.0&ul=en-GB&ua=Mozilla%2F5.0%20%28Macintosh%3B%20Intel%20Mac%20OS%20X%2010_13_1%29%20AppleWebKit%2F537.36%20%28KHTML%2C%20like%20Gecko%29%20Chrome%2F58.0.3029.110%20Safari%2F537.36&vp=100x100&sr=200x200&ec=Video&ea=play&el=solarpod&ev=123&qt=0",
      });
      expect(setCache).toBeCalledWith([]);
    });
